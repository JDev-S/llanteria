                ...
                options = _jquery2.default.extend(!0, {}, defaults, {
                    initComplete: function () {
                        this.api().columns().every(function () {
                            var column = this,
                                select = (0, _jquery2.default)('<select class="form-control w-full"><option value=""></option></select>').appendTo((0, _jquery2.default)(column.footer()).empty()).on("change", function () {
